define([], function () {
    ...
    var Dt = {
        formats: {
            ...
            j: function (d) {
                var gmd_1 = new Date(String(d.getFullYear()) + '/1/1 GMT');
                var gmdate = new Date(String(d.getFullYear()) + '/' + (d.getMonth() + 1) + '/' + d.getDate() + ' GMT');
                var ms = gmdate - gmd_1;
            ...
            V: function (d) {
                ...
                var dow1_1 = (new Date(String(d.getFullYear()) + '/1/1')).getDay();
                var idow = woy + (dow1_1 > 4 || dow1_1 <= 1 ? 0 : 1);
                if (idow === 53 && (new Date(String(d.getFullYear()) + '/12/31')).getDay() < 4) {
                    idow = 1;
                } else if (idow === 0) {
                    idow = Dt.formats.V(new Date(String(d.getFullYear() - 1) + '/12/31'));
                }
        ...
        format: function (oDate, oConfig) {
            ...
            var resources = Hyperion.dateResources[Hyperion.language];
